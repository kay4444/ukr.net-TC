 ...
 */
public class Emails extends Settings{
...
private Button close_pop_up = new Button (By.xpath(Variables.CLOSE_POP_UP_FOR_IMPORT_FROM_OTHER_EMAILS.toString()));

    public Emails select_check_boxes_for_some_emails() {
        OUTERMOST: for (int i = 0; i < 2; i++) {
