...
public class StartPage extends Settings {
    ...
    private Button emails_page = new Button(By.cssSelector(Variables.EMAILS_LINK.toString()));
    ...
    public StartPage login(String logins, String passwords) {
        ...
        login_button.click();
        Element userIsLoggedIn = new Element(By.xpath("//div[text()='" + logins + "']"));
        userIsLoggedIn.waitForElementIsPresent();
        assertTrue(userIsLoggedIn.isPresent() != false, "TC is FAILED - User is NOT logged in");
...
//        checkPageIsReady();
        wait_for_page_header_is_available(20, "eDisk");
        String tab_header1 = getDriver().getTitle();
        System.out.println("Tab 1 is: " + tab_header1);
